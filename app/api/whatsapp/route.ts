...
const STAGE_RULES: { stage: string; parts: string[] }[] = [
  ...
  { stage: 'инженерия', parts: ['электрик', 'электромонтаж', 'кабель', 'щитовая', 'освещени', 'розетк', 'сантехник', 'водопровод', 'канализац', 'отоплени', 'радиатор', 'тёплый пол', 'теплый пол', 'котельн', 'вентиляц', 'воздуховод', 'кондиционер', 'лифт', 'газ', 'газификац', 'пожарн', 'слаботочк', 'видеонаблюдени', 'интернет кабель'] },
